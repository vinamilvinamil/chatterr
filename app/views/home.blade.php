 ...
 <!-- Begin middle content -->
    <div class="container-fluid home-bg">
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="home-box">
            <h4>Fashion axe trust fund vinyl</h4>
            <p>Blue Bottle ugh occupy, single-origin coffee Wes Anderson distillery pop-up fingerstache seitan direct trade street art tattooed High Life hashtag. Cardigan sustainable cliche, fanny pack Godard 3 wolf moon Tonx XOXO. Etsy Vice polaroid PBR&B, photo booth messenger bag</p>
          </div>
        </div>
        <div class="col-sm-4">
          <div class="home-box">
            <h4>Tousled Intelligentsia fashion</h4>
            <p>Yr biodiesel selvage, selfies food truck YOLO vinyl art party ethical single-origin coffee Thundercats keytar chillwave leggings banh mi. Chillwave drinking vinegar cornhole swag wolf authentic. Hashtag whatever Echo Park Pinterest sartorial.</p>
          </div>
        </div>
