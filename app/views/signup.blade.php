...
<div class="container">
	<div class="panel panel-default createAccount">
		<div class="panel-heading"><h4>Create New Account</h4></div>
						...
						<div class="form-group @if($errors->has('Password'))
							...
							<div class="col-sm-4">
								{{ Form::password('Password', array(
									'class' => 'form-control form-mcc',
									'pattern' => '.{8,}',
									'oninvalid' => 'setCustomValidity("Your password needs to be longer than 7 characters.")',
