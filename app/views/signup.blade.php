	...
	<div class="panel panel-default createAccount">
		...
		<div class="panel-body">
			...
			<div class="form-group @if($errors->has('Name'))
				...
				<div class="col-sm-4">
					{{ Form::text('Name', '',array('class' => 'form-control form-mcc')); }}
			...
			<div class="form-group @if($errors->has('Email'))
				...
				<div class="col-sm-4">
					{{ Form::text('Email', '',array('class' => 'form-control form-mcc')); }}
			...
			<div class="form-group @if($errors->has('Password'))
				...
				<div class="col-sm-4">
					...
					<span class="help-block help-form help-form">Must be longer than be longer than 7 characters.</span>
				</div>
				<div class="col-sm-6">
		...
		<div class="panel-footer">
			{{ Form::submit('Create account', array('class' => 'button-mcc')); }}
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="{{ url('/') }}">Cancel</a>
